...
// @license      MIT
// @version      4.8
// @description  Iwara video bulk download, watched video automatically archive download. Support synchronous download introduction, Tag and other works meta-information. Support browser direct download, link export, YT-DLP download command export.
// @author       GitRuozhi
...
(function () {
  ...
  const TEXT = {
  "description": "Iwara video bulk download, watched video automatically archive download. Support Iwara metadata JSON, browser direct download, link export, and YT-DLP command export.",
  "queueTitle": "Queue items with resolved video URLs",
  "activeTitle": "Downloads currently active in this page",
  "successTitle": "Total successful downloads since the last Init",
  "failedTitle": "Total final failures since the last Init",
  "queue": "Queue",
  "active": "Active",
  "success": "Success",
  "failed": "Failed",
  "toggleTitle": "Expand or collapse the panel",
  "init": "Init",
  "initTitle": "Clear queue, page counts, logs, and counters without changing settings",
  "current": "Current",
  "currentTitle": "Collect videos from the current page",
  "multi": "Multi",
  "multiTitle": "Collect videos across multiple list pages",
  "pagesButton": "Pages",
  "start": "Start",
  "startTitle": "Start queue submission; while running, stop submitting new downloads without cancelling browser downloads",
  "stop": "Stop",
  "stopCollect": "Stop",
  "stopSend": "Stop send",
  "stopSendTitle": "Stop submitting new downloads; active browser downloads may continue",
  "again": "Again",
  "againTitle": "Reset failed queue items and start the queue again",
  "more": "More",
  "moreTitle": "Show or hide advanced options",
  "collected": "Collected",
  "pages": "pages",
  "autoQueue": "Auto queue",
  "autoQueueTitle": "Automatically add watched videos to the queue",
  "autoDL": "Auto DL",
  "autoDLTitle": "Automatically start queue downloads after items are queued",
  "meta": "Meta",
  "metaTitle": "Download Iwara metadata JSON before video",
  "threads": "Threads",
  "threadsTitle": "Number of concurrent video resolving requests",
  "pagesLimit": "Pages",
  "pagesLimitTitle": "Maximum pages to collect in one run",
  "mode": "Mode",
  "modeTitle": "Download or export method",
  "browser": "Browser",
  "linksTxt": "Links TXT",
  "ytdlp": "YT-DLP",
  "idm": "IDM",
  "quality": "Quality",
  "qualityTitle": "Preferred Iwara quality",
  "filename": "Filename:",
  "id": "Id",
  "idTitle": "Include video ID in filenames",
  "title": "Title",
  "titleTitle": "Include video title in filenames",
  "original": "Original",
  "originalTitle": "Include original filename in filenames",
  "loaded": "Iwara downloader loaded.",
  "settingsSynced": "Settings synced from another tab.",
  "pageCollected": "Current page collected.",
  "collectNoVideos": "No Iwara video links found on current page.",
  "collectAdded": "Collected videos from page: ",
  "collectStoppedDuplicate": "Duplicate found after wrapping to first page: ",
  "collectStopped": "Collection stopped.",
  "collectionFinished": "Collection finished.",
  "collectNextFailed": "Failed to move to next page.",
  "restoredCollection": "Restored active collection after page change.",
  "autoQueued": "Auto queued watched video",
  "autoCheckFailed": "Auto queue check failed: ",
  "resolveStart": "Resolving queue items: ",
  "resolving": "Resolving ",
  "resolveDone": "Resolved: ",
  "qualityCount": " qualities",
  "resolveFailed": "Resolve failed: ",
  "noDirectUrl": "No downloadable Iwara video source found",
  "externalVideo": "External video cannot be downloaded directly",
  "qualityFallback": "Quality fallback: ",
  "apiFallbackFailed": "Iwara API fallback failed: ",
  "fileUrlFailed": "Iwara fileUrl failed: ",
  "downloadStarted": "Browser download queue started.",
  "downloadStopped": "Stopped queue submission. Active browser downloads may still finish.",
  "noFailed": "No failed downloads to retry.",
  "retrying": "Retrying failed downloads: ",
  "metadataFirst": "Saving metadata: ",
  "metadataDone": "Metadata done: ",
  "downloadSubmit": "Downloading: ",
  "downloadDone": "Download done: ",
  "downloadFailed": "Download failed: ",
  "roundFinished": "Download round finished: ",
  "noResolved": "No resolved videos to output.",
  "linksSaved": "Direct link output files saved.",
  "ytdlpSaved": "YT-DLP output files saved.",
  "idmSaved": "IDM import files saved.",
  "initDone": "Queue initialized.",
  "busyInit": "Cannot initialize while working.",
  "activeReload": "Page reloaded during active download; previous browser download may still finish.",
  "privateOrDenied": "Video is private, unlisted, unavailable, or requires permission.",
  "apiStatus": "Iwara API returned status ",
  "sizeB": "B",
  "sizeKB": "KB",
  "sizeMB": "MB",
  "sizeGB": "GB",
  ...
  const EXPORT_MODE = { DIRECT: 'direct', LINKS: 'links', YTDLP: 'ytdlp', IDM: 'idm' };
